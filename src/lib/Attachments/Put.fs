...
module PutBinary =
    ...
    let asResult (r: Result) =
        ...
        | BadRequest e | NotFound e | Unauthorized e | DbNameMissing e | DocumentIdMissing e | DocumentRevMissing e | AttachmentNameMissing e | DocumentIdMissing e | JsonDeserializationError e | Conflict e | Unknown e ->
